...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AndersenCoreApp.Models.Domain.AddressType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("AndersenCoreApp.Models.Domain.Country", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AndersenCoreApp.Models.Domain.Model", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AndersenCoreApp.Models.Domain.Relation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AndersenCoreApp.Models.Domain.RelationAddress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AndersenCoreApp.Models.Domain.RelationCategory", b =>
                {
                    ...
                    b.ToTable("RelationCategory");
                });

            modelBuilder.Entity("AndersenCoreApp.Models.Domain.Relation", b =>
                {
                    b.HasOne("AndersenCoreApp.Models.Domain.RelationAddress", "RelationAddress")
                        .WithOne()
                        .HasForeignKey("AndersenCoreApp.Models.Domain.Relation", "RelationAddressId");
            ...
            modelBuilder.Entity("AndersenCoreApp.Models.Domain.RelationAddress", b =>
                {
                    b.HasOne("AndersenCoreApp.Models.Domain.Country", "Country")
                        .WithOne()
                        .HasForeignKey("AndersenCoreApp.Models.Domain.RelationAddress", "CountryId");
            ...
            modelBuilder.Entity("AndersenCoreApp.Models.Domain.RelationCategory", b =>
                {
                    ...
                    b.HasOne("AndersenCoreApp.Models.Domain.Relation", "Relation")
            ...
            modelBuilder.Entity("AndersenCoreApp.Models.Domain.Relation", b =>
                {
                    b.Navigation("RelationCategories");
                });
