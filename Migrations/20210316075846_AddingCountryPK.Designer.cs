...
namespace AndersenCoreApp.Migrations
{
    ...
    [Migration("20210316075846_AddingCountryPK")]
    partial class AddingCountryPK
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AndersenCoreApp.Models.AddressType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("AndersenCoreApp.Models.Country", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AndersenCoreApp.Models.Relation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AndersenCoreApp.Models.RelationAddress", b =>
                {
            ...
            modelBuilder.Entity("AndersenCoreApp.Models.Relation", b =>
                {
                    b.HasOne("AndersenCoreApp.Models.RelationAddress", "RelationAddress")
                        .WithMany()
                        .HasForeignKey("RelationAddressId");
            ...
            modelBuilder.Entity("AndersenCoreApp.Models.RelationAddress", b =>
                {
                    b.HasOne("AndersenCoreApp.Models.Country", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AndersenCoreApp.Models.Relation", "Relation")
                        .WithMany()
            ...
            modelBuilder.Entity("CategoryRelation", b =>
                {
                    ...
                    b.HasOne("AndersenCoreApp.Models.Relation", null)
                        .WithMany()
